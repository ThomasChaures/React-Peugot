  ...
  return (
    <>
      <div
        ref={carruselRef}
        id="scrollable"
        className="flex overflow-x-scroll scrollbar-custom gap-6"
      >
      ...
      <div className="pt-4 flex gap-4">
        <button
          onClick={anterior}
          className="px-4 py-2 border text-slate-950 rounded-full hover:bg-slate-950 hover:text-white transition-all"
        >
