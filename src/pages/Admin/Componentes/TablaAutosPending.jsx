                ...
                {filteredAutos.map((auto) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 flex flex-col gap-y-2 text-black text-sm ">
                      <Link
                        to={`/admin/vehicles/pending/check/${auto._id}`}
                      ...
                      <Link
                        to={`/admin/vehicles/delete/${auto._id}`}
                        className="bg-red-600 flex items-center justify-center text-white hover:bg-red-300 py-1 rounded px-1 transition duration-300"
                      >
                        Delete
                      </Link>
                    </td>
