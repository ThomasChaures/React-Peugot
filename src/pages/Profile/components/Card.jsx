...
const Card = ({ auto }) => {
  ...
  return (
    <div className="flex relative flex-col max-w-[1000px] border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all">
      {auto.price <= 24000 && (
